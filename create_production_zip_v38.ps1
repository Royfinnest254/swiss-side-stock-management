# Swiss Side Production V38 Build & Zip Script
Write-Host "==============================================" -ForegroundColor Cyan
Write-Host "SWISS SIDE MANAGEMENT SUITE V38 BUILD & PACKAGE" -ForegroundColor Cyan
Write-Host "==============================================" -ForegroundColor Cyan
...
$source = "backend"
$dest = "production_temp_v38"
$zip = "SwissSide_Production_V38_Flat.zip"

Write-Host "Preparing production package directory..." -ForegroundColor Yellow
if (Test-Path $dest) { Remove-Item -Recurse -Force $dest -ErrorAction SilentlyContinue }

# Exclude node_modules, temp scratch files, large mock data seeds, and existing zips to keep size extremely small
robocopy $source $dest /s /xd node_modules scratch tmp .git /xf *.zip *.log mock_data_seed_1000.sql /njh /njs /ndl /nc /ns /r:0 /w:0
...
if (Test-Path $dest) {
    ...
    try {
        ...
        Write-Host "SUCCESS: V38 Production ZIP created successfully: $zip" -ForegroundColor Green
