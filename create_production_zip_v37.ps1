# Swiss Side Production V37 Build & Zip Script
Write-Host "==============================================" -ForegroundColor Cyan
Write-Host "SWISS SIDE MANAGEMENT SUITE V37 BUILD & PACKAGE" -ForegroundColor Cyan
Write-Host "==============================================" -ForegroundColor Cyan
...
$source = "backend"
$dest = "production_temp_v37"
$zip = "SwissSide_Production_V37_Flat.zip"
...
if (Test-Path $dest) {
    ...
    try {
        ...
        Write-Host "SUCCESS: V37 Production ZIP created successfully: $zip" -ForegroundColor Green
