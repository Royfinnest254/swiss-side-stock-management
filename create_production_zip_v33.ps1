# Swiss Side Production V33 Build & Zip Script
Write-Host "==============================================" -ForegroundColor Cyan
Write-Host "SWISS SIDE MANAGEMENT SUITE V33 BUILD & PACKAGE" -ForegroundColor Cyan
Write-Host "==============================================" -ForegroundColor Cyan
...
$source = "backend"
$dest = "production_temp_v33"
$zip = "SwissSide_Production_V33_Flat.zip"
...
if (Test-Path $dest) {
    ...
    try {
        ...
        Write-Host "SUCCESS: V33 Production ZIP created successfully: $zip" -ForegroundColor Green
