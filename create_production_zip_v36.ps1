# Swiss Side Production V36 Build & Zip Script
Write-Host "==============================================" -ForegroundColor Cyan
Write-Host "SWISS SIDE MANAGEMENT SUITE V36 BUILD & PACKAGE" -ForegroundColor Cyan
Write-Host "==============================================" -ForegroundColor Cyan
...
$source = "backend"
$dest = "production_temp_v36"
$zip = "SwissSide_Production_V36_Flat.zip"
...
if (Test-Path $dest) {
    ...
    try {
        ...
        Write-Host "SUCCESS: V36 Production ZIP created successfully: $zip" -ForegroundColor Green
