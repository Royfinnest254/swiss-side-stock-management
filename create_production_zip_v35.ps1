# Swiss Side Production V35 Build & Zip Script
Write-Host "==============================================" -ForegroundColor Cyan
Write-Host "SWISS SIDE MANAGEMENT SUITE V35 BUILD & PACKAGE" -ForegroundColor Cyan
Write-Host "==============================================" -ForegroundColor Cyan
...
$source = "backend"
$dest = "production_temp_v35"
$zip = "SwissSide_Production_V35_Flat.zip"
...
if (Test-Path $dest) {
    ...
    try {
        ...
        Write-Host "SUCCESS: V35 Production ZIP created successfully: $zip" -ForegroundColor Green
